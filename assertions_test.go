...
2 2       <32>1<39>,
<31>3   -<39>     <32><41><39><30>2<39><32><49><39>,
<32>  3 +<39>     <32><42><39><30>3<39><32><49><39>,
4 4   }

`)

	g.Eq("abc", "axc")
	m.checkWithStyle(true, `<33>"a<41><39><30>b<39><33><49>c"<39> <31><4>⦗not ==⦘<24><39> <33>"a<42><39><30>x<39><33><49>c"<39>`)

	g.Eq(3, "a")
	m.checkWithStyle(true, `<32><41><39><30>3<39><32><49><39> <31><4>⦗not ==⦘<24><39> <32><42><39><30>"<39><32><49><42><39><30>a<39><32><49><42><39><30>"<39><32><49><39>`)
}
